 ...
 */
export const APP_NAME = "moodcaster";

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = "Cast your Opinions on Farcaster Polls";
 ...
 */
export const APP_TAGS = ["polls", "social"];
...
export const APP_ACCOUNT_ASSOCIATION: AccountAssociation | undefined = {
  ...
  payload: "eyJkb21haW4iOiJtb29kY2FzdGVyLnZlcmNlbC5hcHAifQ",
  signature:
    "IBeSStDcFk0ThbzTIJgonoyl0C/YokzunXQbSysiFcwEymmeFrs9mx3Lf/954kCtwnvds335+gjrwkdPP3Elgxw=",
};
 ...
 */
export const APP_BUTTON_TEXT = "Create Poll";
